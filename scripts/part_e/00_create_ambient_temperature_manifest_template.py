...
def write_reports(records: pd.DataFrame, template: pd.DataFrame) -> None:
    ...
    summary_lines = [
        ...
        "## Delta-T Formula",
        "",
        "`delta_t_c = temperature_c - ambient_temperature_c` for every accepted finite thermal pixel.",
        "",
        "All finite pixels are preserved in canonical Parquet. Formal figures use spatially thinned original pixels without LUHK-cell, tile, or neighbouring-pixel averaging; spatial autocorrelation remains.",
        "",
        ...
        "",
        "- Canonical pixel-level delta-T Parquet: not generated.",
        "- Five formal sampled-pixel datasets: not generated.",
        "- LUHK, surface-cover, and image-level summaries: not generated.",
        "- Exploratory statistical tests: not run.",
        "- Primary pixel-level delta-T spectrum figures: not generated.",
