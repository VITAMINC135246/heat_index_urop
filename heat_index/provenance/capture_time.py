...
DJI_METADATA_PATH = data_root(PROJECT_ROOT) / "metadata" / "dji_image_metadata.xlsx"
...
def dji_metadata_for_paths(
    ...
    *,
    ...
    for record in _metadata_records(str(metadata_path.resolve())):
        ...
        resolved = _normal_path(resolve_path(str(record.get("image_path", "")), PROJECT_ROOT).resolve()) if record_path else ""
