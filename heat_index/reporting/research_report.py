...
def workflow_diagram(path):
    ...
    regular_font = font_manager.findfont(font_manager.FontProperties(family="DejaVu Sans"))
    bold_font = font_manager.findfont(font_manager.FontProperties(family="DejaVu Sans", weight="bold"))
    regular = ImageFont.truetype(regular_font, 28)
    bold = ImageFont.truetype(bold_font, 34)
