...
from heat_index.spatial.alignment import crop_for_alignment

from heat_index.spatial.landuse import NativeLUHKResult
from heat_index.classification.review import SuperpixelReviewController, run_review_gui_subprocess
...
def prepare_part_c_review(
    *,
    ...
    roi.save(roi_path)
    from heat_index.classification import superpixels as legacy
