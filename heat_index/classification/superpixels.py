...
from heat_index.io.coerce import as_float, as_int
...
from heat_index.io.tables import read_table, write_rows
from heat_index.spatial.review import accepted_alignment_rows
...
GRID_XLSX = data_root(PROJECT_ROOT) / "processed" / "grids" / "pilot_luhk_aligned_10m_grid_cells.xlsx"
FOOTPRINTS_XLSX = data_root(PROJECT_ROOT) / "processed" / "footprints" / "image_footprints.xlsx"
VISIBLE_CAMERA_PROFILES_XLSX = data_root(PROJECT_ROOT) / "metadata" / "visible_camera_profiles.xlsx"
THERMAL_METADATA_XLSX = data_root(PROJECT_ROOT) / "metadata" / "dji_image_metadata.xlsx"

ANNOTATION_DIR = data_root(PROJECT_ROOT) / "annotations" / "part_c"
