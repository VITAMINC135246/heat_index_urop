...
from heat_index.provenance.models import LUHKProvenance
...
def load_native_luhk_result(
    ...
    *,
    ...
    grid_file = grid_path or resolve_path(DEFAULT_GRID_RELATIVE_PATH, root)
    footprints_file = footprints_path or resolve_path(DEFAULT_FOOTPRINTS_RELATIVE_PATH, root)
    raster_file = raster_path or resolve_path(DEFAULT_RASTER_RELATIVE_PATH, root)
    sources = {
