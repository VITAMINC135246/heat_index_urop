...
from heat_index.io.coerce import as_float
...
from heat_index.provenance.camera_profiles import (  # noqa: E402
    MATRICE_4T_CAMERA_RULES,
    classify_matrice_4t_camera,
    resolve_camera_parameters,
)
from heat_index.io.tables import read_table, write_rows  # noqa: E402


CANDIDATE_PAIRS_XLSX = data_root(PROJECT_ROOT) / "metadata" / "pilot_candidate_pairs.xlsx"
DJI_METADATA_XLSX = data_root(PROJECT_ROOT) / "metadata" / "dji_image_metadata.xlsx"
VISIBLE_CAMERA_PROFILES_XLSX = data_root(PROJECT_ROOT) / "metadata" / "visible_camera_profiles.xlsx"
PART_B_PILOT_PAIRS_XLSX = data_root(PROJECT_ROOT) / "metadata" / "part_b_pilot_pairs.xlsx"
ANNOTATION_DIR = data_root(PROJECT_ROOT) / "annotations" / "part_b_round1"
COMBINED_ANNOTATION_XLSX = data_root(PROJECT_ROOT) / "annotations" / "part_b_round1_segment_annotations.xlsx"
SURFACE_CLASSES_XLSX = data_root(PROJECT_ROOT) / "annotations" / "surface_cover_classes.xlsx"
