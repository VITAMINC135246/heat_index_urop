...
from heat_index.io.validation import image_identifier
from heat_index.spatial.landuse import resolve_luhk_context
from heat_index.thermal.measurements import parse_tat3_report, write_temporary_tat3_bundle
...
def validate_surface_cover(value: str) -> str:
    mapping_path = data_root(PROJECT_ROOT) / "annotations" / "part_c" / "surface_cover_class_mapping.xlsx"
