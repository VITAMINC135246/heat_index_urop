...
from heat_index.analysis.aggregate import (
...
from heat_index.analysis.temporal import TemporalRunResult, run_temporal_analysis
...
PART_E_DEPENDENCIES = [
    ...
    PROJECT_ROOT / "heat_index" / "pipeline" / "analysis_stages.py",
    PROJECT_ROOT / "heat_index" / "analysis" / "pixels.py",
    PROJECT_ROOT / "heat_index" / "analysis" / "sampling.py",
    PROJECT_ROOT / "heat_index" / "analysis" / "statistics.py",
    PROJECT_ROOT / "heat_index" / "visualization" / "spectra.py",
    PROJECT_ROOT / "heat_index" / "visualization" / "spatial_maps.py",
    PROJECT_ROOT / "heat_index" / "analysis" / "temporal.py",
]
...
def run_formal_part_e(
    ...
    *,
    ...
    command = [
        sys.executable,
        "-m", "heat_index.pipeline.analysis_stages",
