...
from heat_index.provenance.models import ManualReviewStatus, ProcessingRoute, QAStatus, SourceMethod
from heat_index.analysis.aggregate import aggregate_canonical_results
from heat_index.analysis.temporal import run_temporal_analysis
...
def main() -> int:
    ...
    spatial = subprocess.run(
        [sys.executable, str(PROJECT_ROOT / "heat_index" / "visualization" / "spatial_maps.py"), "--config", str(config_path)],
