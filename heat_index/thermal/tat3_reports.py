...
from heat_index.config.paths import logical_path, data_root
...
DEFAULT_REPORT_DIR = data_root(PROJECT_ROOT) / "local_external" / "tat3_reports" / "raw"
PILOT_PAIRS_XLSX = data_root(PROJECT_ROOT) / "metadata" / "part_b_pilot_pairs.xlsx"
VT_PAIRS_XLSX = data_root(PROJECT_ROOT) / "metadata" / "vt_pairs.xlsx"
