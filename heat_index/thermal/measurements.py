...
from heat_index.analysis.extremes import extreme_summary
from heat_index.provenance.models import MeasurementType
...
def _text_lines(path: Path) -> list[str]:
    ...
    from heat_index.thermal import tat3_reports as legacy
